...
// Old Full-range model (1-120 m regression fit)
// RSSI(d) = -23.199*log10(d) - 44.046

// Old Long-range model (1-100 m regression fit)
// RSSI(d) = -21.39*log10(d) - 46.29

// Old Short-Mid-range model (1-70 m regression fit)
// RSSI(d) = -18.531*log10(d) - 49.55

// Raw RSSI long-range model (1-130 m regression fit)
// RSSI(d) = -24.799*log10(d) - 45.223

// Raw RSSI long-range model (1-100 m regression fit)
// RSSI(d) = -24.87*log10(d) - 45.113

// Raw RSSI short-mid-range model (1-70 m regression fit)
// RSSI(d) = -22.46*log10(d) - 47.89
...
void loop() {
  ...
  // -------------------- Trilateration --------------------
  // Use only active (non-stale) transmitters
